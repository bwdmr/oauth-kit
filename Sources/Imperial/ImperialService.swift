...
//public protocol ImperialServiceCache: ImperialService {
//  var req: Request { get }
//  var url: URL { get }
//  var grants: [String: @Sendable (String) -> ImperialGrantable] { get set }
//  
//  init(
//    req: Vapor.Request,
//    url: URL,
//    grants: [String: @Sendable (String) -> ImperialGrantable]
//  )
//  
//  init(
//    req: Vapor.Request,
...
//extension ImperialServiceCache {
//  init(
//    req: Vapor.Request,
//    url: URL,
//    clientID: String,
